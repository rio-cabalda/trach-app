...
const Page = () => {
  ...
  return (
    <section className="bg-[url('/under.png')] bg-cover bg-no-repeat bg-center bg-white dark:bg-gray-900 relative z-1">
      {showJumbotron && (
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 relative z-10">
          ...
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
           OOOPS THIS PAGE IS STILL UNDER CONSTRUCTION
          </h1>
          <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">
            Please click the logo below to navigate back to Home page
          </p>
          <Link href={"/"} className="hero justify-center py-5">
            <Image src={"logo-new.svg"} alt='logo' width={150} height={150}>
      ...
      <div className="bg-gradient-to-b from-blue-50 to-transparent dark:from-blue-900 w-full h-full absolute top-0 left-0"></div>
    </section>
  );
};
